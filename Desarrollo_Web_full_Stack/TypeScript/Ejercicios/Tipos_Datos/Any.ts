...
(() =>{
    ...
    let longitudDelString: number = (variableSinTipo as string).length;
    ...
    let Usuario: any = "Hola Mundo";
    console.log((Usuario as string).toUpperCase() );
    console.log(<string>Usuario.charAt(0));

    Usuario = 3.1416352;
    console.log((Usuario as number).toFixed(4) );
